...
type UserServiceClient interface {
	...
	Subscribe(ctx context.Context, in *User, opts ...grpc.CallOption) (*Nothing, error)
}
...
func (c *userServiceClient) Subscribe(ctx context.Context, in *User, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
type UserServiceServer interface {
	...
	Subscribe(context.Context, *User) (*Nothing, error)
...
func (UnimplementedUserServiceServer) Subscribe(context.Context, *User) (*Nothing, error) {
...
func _UserService_Subscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Subscribe(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
