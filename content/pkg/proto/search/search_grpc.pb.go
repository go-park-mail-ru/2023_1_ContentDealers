...
func (c *searchServiceClient) Search(ctx context.Context, in *SearchParams, opts ...grpc.CallOption) (*SearchResponse, error) {
...
func (UnimplementedSearchServiceServer) Search(context.Context, *SearchParams) (*SearchResponse, error) {
...
func _SearchService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).Search(ctx, req.(*SearchParams))
	}
