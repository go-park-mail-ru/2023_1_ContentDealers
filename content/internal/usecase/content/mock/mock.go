...
func (m *MockRepository) AddRating(ctx context.Context, ContentID uint64, rating float32) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddRating", ctx, ContentID, rating)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddRating indicates an expected call of AddRating.
func (mr *MockRepositoryMockRecorder) AddRating(ctx, ContentID, rating interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddRating", reflect.TypeOf((*MockRepository)(nil).AddRating), ctx, ContentID, rating)
}

// DeleteRating mocks base method.
func (m *MockRepository) DeleteRating(ctx context.Context, ContentID uint64, rating float32) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteRating", ctx, ContentID, rating)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteRating indicates an expected call of DeleteRating.
func (mr *MockRepositoryMockRecorder) DeleteRating(ctx, ContentID, rating interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteRating", reflect.TypeOf((*MockRepository)(nil).DeleteRating), ctx, ContentID, rating)
}
...
// GetEpisodesBySeasonNum mocks base method.
func (m *MockRepository) GetEpisodesBySeasonNum(ctx context.Context, ContentID uint64, seasonNum uint32) ([]domain.Episode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEpisodesBySeasonNum", ctx, ContentID, seasonNum)
	ret0, _ := ret[0].([]domain.Episode)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEpisodesBySeasonNum indicates an expected call of GetEpisodesBySeasonNum.
func (mr *MockRepositoryMockRecorder) GetEpisodesBySeasonNum(ctx, ContentID, seasonNum interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEpisodesBySeasonNum", reflect.TypeOf((*MockRepository)(nil).GetEpisodesBySeasonNum), ctx, ContentID, seasonNum)
}
