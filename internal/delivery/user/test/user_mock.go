...
// HasAccessContent mocks base method.
func (m *MockUserUsecase) HasAccessContent(ctx context.Context, originalURI, cookie string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasAccessContent", ctx, originalURI, cookie)
	ret0, _ := ret[0].(error)
	return ret0
}

// HasAccessContent indicates an expected call of HasAccessContent.
func (mr *MockUserUsecaseMockRecorder) HasAccessContent(ctx, originalURI, cookie interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasAccessContent", reflect.TypeOf((*MockUserUsecase)(nil).HasAccessContent), ctx, originalURI, cookie)
}
